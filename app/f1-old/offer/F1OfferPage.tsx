...
function CtaButton({ label, className, location, href }: { label: string; className?: string; location?: string; href: string }) {
  ...
  const handleClick = useCallback(() => {
    setLoading(true);
    trackGa4Event("f1_offer_cta_clicked", { funnel: "f1-old", cta_location: location ?? "unknown", cta_label: label });
  }, [label, location]);
...
export default function F1OfferPage() {
  ...
  useEffect(() => {
    trackGa4Event("view_offer", { funnel: "f1-old", page_path: "/f1-old/offer" });
    trackEvent("view_offer", { funnel: "f1-old", page_path: "/f1-old/offer" });
    ...
    <div className="program-page program-page--theme-test f1-page f1-offer-page">
      ...
      <header className="program-nav f1-offer-nav">
        <div className="program-nav__inner">
          <a href="/f1-old" className="program-nav__logo" aria-label="Back to advertorial">
            <Image
