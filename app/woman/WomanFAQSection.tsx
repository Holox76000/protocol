  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Not necessarily. Some recommendations are free, some are low-cost, and some require more investment. The point is to stop wasting money on random products and generic plans that do not fit your body.",
      },
      {
