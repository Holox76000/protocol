...
export function getFunnelConfig(funnel: FunnelVariant = "main"): FunnelConfig {
  ...
  return {
    ...
    landingPrimaryLabel: "Get My Plan",
    landingSecondaryLabel: "See My Transformation",
    pricingCtaLabel: "Get My Plan",
    transformationCtaLabel: "Start Now",
    footerCtaLabel: "Get My Plan",
