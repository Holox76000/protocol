...
export function getFunnelConfig(funnel: FunnelVariant = "main"): FunnelConfig {
  if (funnel === "f1") {
    ...
    return {
      ...
      landingPrimaryLabel: "Start your Protocol — $89",
      landingSecondaryLabel: "Start your Protocol",
      pricingCtaLabel: "Start your Protocol — $89",
      transformationCtaLabel: "Start your Protocol — $89",
      footerCtaLabel: "Start your Protocol — $89",
